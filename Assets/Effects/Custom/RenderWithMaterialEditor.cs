...
public class RenderWithMaterialEditor : PostProcessEffectEditor<RenderWithMaterial>
{
    ...
    protected void MaterialPropertiesGui(Material material)
    {
        ...
        if (materialEditor == null || cachedMaterial != material)
        {
            ...
            materialEditor = (MaterialEditor) Editor.CreateEditor(cachedMaterial, typeof(MaterialEditor));
        }
        ...
        Attribute[] attributes)
    {
        ...
        return (SerializedParameterOverride) Activator.CreateInstance(typeof(SerializedParameterOverride), flags, null,
